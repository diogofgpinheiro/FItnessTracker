...
public class adpterAlmoco extends RecyclerView.Adapter<adpterAlmoco.ViewHolder> {
    ...
    public adpterAlmoco(Context context, List<itemsPesquisaAlimentos> dados, String refeicao, String data) {
