...
public class adapterLanche extends RecyclerView.Adapter<adapterLanche.ViewHolder> {
    ...
    public adapterLanche(Context context, List<itemsPesquisaAlimentos> dados, String refeicao, String data) {
