...
public class adapterJantar extends RecyclerView.Adapter<adapterJantar.ViewHolder> {
    ...
    public adapterJantar(Context context, List<itemsPesquisaAlimentos> dados, String refeicao, String data) {
